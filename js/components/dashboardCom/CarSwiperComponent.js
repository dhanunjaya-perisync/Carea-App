...
export const CarSwiperComponent = ({percentage,deals,description,imageUri,contain,height,bottom,marginBottom}) => {

  const EachSwiper = ({percentage,deals,description,imageUri,contain}) => {
    return (
      <View style={[styles.row,styles.centerHorizontal,styles.bgLightGrey,radius(25),paddingPoistion(0,20,0,20)]}>
    <View>
  ...
  return(
    <Swiper style={[{height:height?height:180,},marginPosition(0,0,marginBottom?marginBottom:0,0)]} paginationStyle={{bottom:bottom?bottom:10}} activeDotColor="#000" activeDotStyle={{width:25,height:5}} dotStyle={{width:5,height:5,}} autoplay={true} autoplayTimeout={4}>

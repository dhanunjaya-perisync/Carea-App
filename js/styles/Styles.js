...
// - - - - - CUSTOM SPACING AND BORDER - - - - - - //
    ...
    export const gap = (value) => {
        return StyleSheet.create({gap:value})
    }
...
// - - - - - BORDER COLORS - - - - - //
    ...
    borderGrey: {borderColor: Colors.grey},
    borderLightGrey: {borderBlockColor: Colors.lightGrey},

// - - - - - FontWieght - - - - - //

    normalWieght :{fontWeight:"500"},
    boldWieght:{fontWeight:"bold"},
...
// - - - - - OTHER CSS - - - - - // 
    ...
    //Poppins font family
    poppinsReg:{fontFamily:"Poppins-Regular"},
    poppinsBold:{fontFamily:"Poppins-Bold"},
    poppinsEB:{fontFamily:"Poppins-ExtraBold"},
